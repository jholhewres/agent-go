...
```go
import "github.com/jholhewres/agent-go/pkg/agentgo/models/deepseek"
...
import (
    ...
    "github.com/jholhewres/agent-go/pkg/agentgo/models/deepseek"
...
```bash
# Run tests
go test -v ./pkg/agentgo/models/deepseek/

# With coverage
go test -v -cover ./pkg/agentgo/models/deepseek/

# Generate coverage report
go test -coverprofile=coverage.out ./pkg/agentgo/models/deepseek/

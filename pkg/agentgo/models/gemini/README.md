...
```go
import "github.com/jholhewres/agent-go/pkg/agentgo/models/gemini"
...
import (
    ...
    "github.com/jholhewres/agent-go/pkg/agentgo/models/gemini"
...
```bash
# Run tests
go test -v ./pkg/agentgo/models/gemini/

# With coverage
go test -v -cover ./pkg/agentgo/models/gemini/

# Generate coverage report
go test -coverprofile=coverage.out ./pkg/agentgo/models/gemini/

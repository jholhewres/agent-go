...
AgentGo는 단순한 프레임워크가 아닌 완전한 프로덕션 시스템입니다. 포함된 **AgentOS** 서버는 다음을 제공합니다:
...
- **Issues**: [버그 리포트 및 기능 요청](https://github.com/jholhewres/agent-go/issues)
- **Discussions**: [질문 및 아이디어 공유](https://github.com/jholhewres/agent-go/discussions)

## 라이센스

AgentGo는 [MIT 라이센스](https://github.com/jholhewres/agent-go/blob/main/LICENSE)로 배포됩니다.

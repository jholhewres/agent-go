---
title: 릴리스 노트
description: AgentGo의 버전 히스토리 및 릴리스 노트
outline: deep
---
...
### ✨ 하이라이트
- **EvoLink 프로바이더**: `pkg/agentgo/providers/evolink` 및 `pkg/agentgo/models/evolink/*` 아래에서 텍스트·이미지·비디오 생성을 지원하고, EvoLink 제약에 맞는 옵션 구조체와 비동기 태스크 폴링을 제공합니다.
...
엔터프라이즈 검수 절차: [`docs/ENTERPRISE_MIGRATION_PLAN.md`](https://github.com/jholhewres/agent-go/blob/main/docs/ENTERPRISE_MIGRATION_PLAN.md) 참고.
...
- **GitHub 릴리스:** [v1.1.0](https://github.com/jholhewres/agent-go/releases/tag/v1.1.0)
- **전체 변경 로그:** [CHANGELOG.md](https://github.com/jholhewres/agent-go/blob/main/CHANGELOG.md)
...
AgentGo v1.0은 Agno 멀티 에이전트 프레임워크의 고성능 Go 구현입니다.

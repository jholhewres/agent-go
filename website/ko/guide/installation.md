...
이 가이드는 AgentGo를 설치하고 설정하는 다양한 방법을 다룹니다.
...
1. [GitHub Issues](https://github.com/jholhewres/agent-go/issues) 확인
2. [Discussions](https://github.com/jholhewres/agent-go/discussions)에서 질문
3. [문서](/guide/) 검토

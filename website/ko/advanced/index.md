...
AgentGo의 고급 개념, 성능 최적화, 배포 전략 및 테스트 모범 사례를 심도 있게 알아봅니다.
...
AgentGo의 모듈식 아키텍처와 설계 철학에 대해 알아보기:
...
AgentGo에 기여하고 싶으신가요? 확인해보세요:

- [아키텍처 문서](/ko/advanced/architecture) - 코드베이스 이해하기
- [테스트 가이드](/ko/advanced/testing) - 테스트 표준 배우기
- [GitHub 저장소](https://github.com/jholhewres/agent-go) - PR 제출하기
- [개발 가이드](https://github.com/jholhewres/agent-go/blob/main/CLAUDE.md) - 개발 환경 설정

## 추가 리소스

### 문서

- [Go 패키지 문서](https://pkg.go.dev/github.com/jholhewres/agent-go)
- [Python Agno 프레임워크](https://github.com/agno-agi/agno) (영감의 원천)
- [VitePress 문서 소스](https://github.com/jholhewres/agent-go/tree/main/website)
...
**참고**: 이 섹션은 AgentGo의 기본 개념에 익숙하다고 가정합니다. 처음이라면 [가이드](/ko/guide/) 섹션부터 시작하세요.

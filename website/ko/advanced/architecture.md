...
AgentGo는 단순성, 효율성, 확장성을 위해 설계된 깨끗하고 모듈화된 아키텍처를 따릅니다.
...
**파일**: `pkg/agentgo/workflow/workflow.go`
...
- [API 참조](/api/)
- [소스 코드](https://github.com/jholhewres/agent-go)

...
### ✨ 亮点
- **EvoLink 媒体 Provider**：在 `pkg/agentgo/providers/evolink` 与 `pkg/agentgo/models/evolink/*` 下提供文本、图片、视频模型，支持异步任务轮询与类型安全参数。
...
企业验收步骤请参考 [`docs/ENTERPRISE_MIGRATION_PLAN.md`](https://github.com/jholhewres/agent-go/blob/main/docs/ENTERPRISE_MIGRATION_PLAN.md)。
...
- **完整变更日志：** [CHANGELOG.md](https://github.com/jholhewres/agent-go/blob/main/CHANGELOG.md)
...
AgentGo v1.0 是 Agno 多智能体框架的高性能 Go 实现。
...
完整版本历史请参见 [CHANGELOG.md](https://github.com/jholhewres/agent-go/blob/main/CHANGELOG.md)。

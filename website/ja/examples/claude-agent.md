...
この例では、AgentGo で Anthropic の Claude モデルを使用する方法を示します。Claude は、思慮深く詳細な回答と強力な推論能力で知られています。この例では、シンプルな会話、計算機ツールの使用、複雑な計算、数学的推論など、複数のユースケースを紹介します。

## 学べること

- Anthropic Claude を AgentGo と統合する方法

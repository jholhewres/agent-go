---
title: リリースノート
description: AgentGoのバージョン履歴とリリースノート
outline: deep
---
...
### ✨ ハイライト
- **EvoLink プロバイダー**: `pkg/agentgo/providers/evolink` および `pkg/agentgo/models/evolink/*` により、テキスト・画像・動画の生成をサポートし、EvoLink ドキュメントに沿ったオプション構造体と非同期タスクポーリングを提供します。
...
企業向けの検収手順は [`docs/ENTERPRISE_MIGRATION_PLAN.md`](https://github.com/jholhewres/agent-go/blob/main/docs/ENTERPRISE_MIGRATION_PLAN.md) を参照してください。
...
- **GitHubリリース:** [v1.1.0](https://github.com/jholhewres/agent-go/releases/tag/v1.1.0)
- **完全な変更ログ:** [CHANGELOG.md](https://github.com/jholhewres/agent-go/blob/main/CHANGELOG.md)
...
AgentGo v1.0は、Agnoマルチエージェントフレームワークの高性能Go実装です。

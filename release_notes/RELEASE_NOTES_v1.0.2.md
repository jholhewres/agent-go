...
### Go Get
```bash
go get github.com/jholhewres/agent-go@v1.0.2
```

### Update Existing Installation
```bash
go get -u github.com/jholhewres/agent-go
```
...
- **pkg/agentgo/models/glm/README.md** - Comprehensive GLM usage guide
...
- **Documentation**: [https://github.com/jholhewres/agent-go](https://github.com/jholhewres/agent-go)
- **Issues**: [https://github.com/jholhewres/agent-go/issues](https://github.com/jholhewres/agent-go/issues)
- **Discussions**: [https://github.com/jholhewres/agent-go/discussions](https://github.com/jholhewres/agent-go/discussions)

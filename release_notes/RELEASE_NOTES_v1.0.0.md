...
```bash
go get github.com/jholhewres/agent-go@v1.0.0
```
...
- 📖 [API Documentation](https://pkg.go.dev/github.com/jholhewres/agent-go)
...
- **Go Packages**: https://pkg.go.dev/github.com/jholhewres/agent-go

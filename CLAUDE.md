...
**AgentGo** 是一个高性能的 Go 语言多智能体系统框架,继承自 Python Agno 的设计理念,利用 Go 的并发模型和性能优势构建高效、可扩展的 AI Agent 系统。
...
#### 3. Workflow (pkg/agentgo/workflow/)
基于步骤的工作流引擎,支持 5 种原语:
...
1. 创建目录: `pkg/agentgo/models/<your_model>/`
...
1. 创建目录: `pkg/agentgo/tools/<your_tool>/`

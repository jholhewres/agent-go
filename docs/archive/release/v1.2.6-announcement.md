...
**Call to action:**  
Upgrade via `go get github.com/jholhewres/agent-go@v1.2.6`, skim the new session API examples, and let us know how the caching layer affects your workloads.
...
Update today → go get github.com/jholhewres/agent-go@v1.2.6
```

## 1. Implementation
- [x] 1.1 Create `pkg/agentgo/providers/evolink` with shared HTTP client, config, and task polling utilities aligned with `/home/rex/下载/Sora-2 视频生成 - EvoLink.html` and `https://docs.evolink.ai/en/api-manual/image-series/gpt-4o/gpt-4o-image-generation`.
